...
function custom_taxonomy() {
	...
	$labels = array(
		'name'							=> _x( 'Flickr Albums', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'					=> _x( 'Flickr Album', 'Taxonomy Singular Name', 'text_domain' ),
	...
	register_taxonomy( 'flickr_album', array( 'post' ), $args );
}
